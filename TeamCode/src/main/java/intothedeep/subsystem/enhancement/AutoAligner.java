package intothedeep.subsystem.enhancement;
...
import intothedeep.control.controller.PIDController;
import intothedeep.sensor.DistanceSensorEx;
...
//    public static final double SENSOR_DISTANCE = 2.5625;
    ...
    public PoseVelocity2d run(double y) {
        ...
        double theta = 0; //Math.toDegrees(robot.drivetrain. - robot.drivetrain.pose.heading.toDouble());
